...
def draw_board():
    print("  +---+---+---+")
    print(str(2) + " | " + board[2][0] + " | " +
          board[2][1] + " | " + board[2][2] + " |")
    print("  +---+---+---+")
    print(str(1) + " | " + board[1][0] + " | " +
          board[1][1] + " | " + board[1][2] + " |")
    print("  +---+---+---+")
    print(str(0) + " | " + board[0][0] + " | " +
          board[0][1] + " | " + board[0][2] + " |")
    print("  +---+---+---+")
    print("    0   1   2")
...
def check_diagonals():
    return ((board[0][0] == board[1][1] and board[1][1] == board[2][2]) and board[0][0] != " ") or \
        ((board[2][0] == board[1][1] and board[1]
         [1] == board[0][2]) and board[2][0] != " ")
...
def main():
    seed(datetime.now())
    level = get_int("Choose level(1-easy, 2-hard): ")
    ...
    for _ in range(9):
        ...
        while player == "X":
            ...
            if row < 0 or row > 2:
                print("Row out bounds (0-2). ")
                continue
            elif col < 0 or col > 2:
                print("Column out bounds (0-2). ")
                continue
            elif board[row][col] != " ":
